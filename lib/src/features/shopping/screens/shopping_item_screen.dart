...
import 'package:plate_post/src/models/enums/importance_enum.dart';
...
import 'package:plate_post/src/features/shopping/widgets/shopping_tile.dart';
...
class _ShoppingItemScreenState extends State<ShoppingItemScreen> {
  ...
  int _currentColor = kOrangeColorTint2.toARGB32();
  @override
  void initState() {
    super.initState();
